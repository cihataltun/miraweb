	   ...
	   <aside class="sidebar">
		  <div class="nav-menu nav-sidebar">
			 <div class="sidebar-options">
				<a href="#" class="burger js-menu-toggle navbar-text"
				   data-toggle="collapse" data-target="#main-navbar">
				   <i class="fa-regular fa-circle-xmark"></i>
				   <p class="navbar-text ">MENU</p>
				</a>
				<a href="{{ route('en-main-homepage') }}"><img class="sidebar-logo" src="{{ asset('assets/frontend/images/header/miramare-logo.webp') }}"></a>
			 ...
			 <ul class="sidebar-list">
				<li class="sidebar-item " >
				   <div class="dropdown sidebar-hotels-dropdown" >
					  <a onclick="sidebarDropdown()" href="#" class="sidebar-links dropdown-toggle" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
					  HOTELS
					  </a>
					  <ul class="dropdown-menu sidebar-hotels-dropdown-list" aria-labelledby="dropdownMenuButton1">
						 <li><a class="dropdown-item" href="#">Miramare Queen</a></li>
						 <li><a class="dropdown-item" href="#">Miramare Beach</a></li>
					  </ul>
				   </div>
				</li>
				<li class="sidebar-item">
			 ...
			 <div class="sidebar-contact">
				...
				<a class="sidebar-whatsapp" href="#">
				   <i class="fa-brands fa-whatsapp"></i>
				   <p class="sidebar-text whatsapp-text">WhatsApp</p>
				</a>
				<a class="sidebar-phone" href="#">
